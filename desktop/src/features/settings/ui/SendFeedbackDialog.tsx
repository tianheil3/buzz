...
/** English labels for non-UI callers (id → canonical English). */
          ...
          <div className="flex items-stretch gap-3">
            ...
            {resolvedAttachedImageUrl ? (
              <div className="group/attachment relative flex w-32 shrink-0 flex-col overflow-hidden rounded-lg border border-border/70 bg-muted/40">
                <button
                  aria-label={t("settings.feedback.viewAttached")}
                ...
                >
                  <img
                    alt={t("settings.feedback.attached")}
                  ...
                  <span className="flex items-center gap-1 px-2 py-1.5 text-2xs font-medium text-muted-foreground">
                    ...
                    />
                    <span className="truncate">{t("settings.feedback.attachedImage")}</span>
                  </span>
                </button>
                <button
              ...
              <button
                aria-label={t("settings.feedback.attachImage")}
              ...
              >
                ...
                {isAttaching ? t("settings.feedback.attaching") : t("settings.feedback.attachImage")}
              </button>
            )}
          </div>
